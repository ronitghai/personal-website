      ...
      <div className="hero-grid">
        <section>
          ...
          <p className="hero-summary">
            ...
            clean backend logic, cloud infrastructure, and intuitive interfaces. I enjoy working
            across the stack—from microcontrollers and PCB design to React frontends and
            production-ready APIs in the cloud.
          </p>
        ...
        <aside className="hero-card">
          ...
          <p className="hero-metric-label">
            I like building things that have to be fast, secure, and reliable—whether it&apos;s a
            smart suitcase, a file integrity verifier, or an AI assistant.
          </p>
      ...
      <section id="skills" style={{ marginTop: '3.5rem' }}>
        ...
        <div className="grid grid-3">
          ...
          <div className="card">
            ...
            <p className="card-body">
              React, Vue, Next.js, Node.js, Express, FastAPI, Flask, Django, Tailwind, Docker,
              Git, Postman.
            </p>
          </div>
          <div className="card">
            ...
            <p className="card-body">
              AWS, Azure, GCP, Terraform, REST APIs, LLMs, LangChain, TensorFlow, PyTorch,
              scikit-learn, PostgreSQL, MongoDB.
            </p>
          </div>
        </div>
      </section>
